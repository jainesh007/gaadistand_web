...
class SearchOTPVerifyScreen extends StatefulWidget {

  String mobile_number;

  SearchOTPVerifyScreen(this.mobile_number);
  @override
  _SearchOTPVerifyScreenState createState() => new _SearchOTPVerifyScreenState(mobile_number);
}

class _SearchOTPVerifyScreenState extends State<SearchOTPVerifyScreen> {

  String mobile_number;
  String currentText;

  _SearchOTPVerifyScreenState(this.mobile_number);
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: RaisedButton(
                      ...
                      child: Text(AppTranslations.of(context).text("verify_otp"), style: TextStyle(color: Colors.black, fontSize: 18)),
                      onPressed: () {
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Padding(
                    ...
                    child: Text("Please provide valid OTP",
