...
class _CreatePostScreenState extends State<CreatePostScreen> {
  ...
  TextEditingController txt_car_type = new TextEditingController(text:'');
  ...
  void initState() {
    super.initState();
    FirebaseAnalytics().setCurrentScreen(screenName: 'Create PostScreen');
                ...
                children: <Widget>[
                  ...
                  Center(
                    child: Padding(
                      ...
                      child: Text(AppTranslations.of(context).text("create_your_post"),style:TextStyle(fontSize: 20.0,
                          color: Colors.black, fontWeight:FontWeight.bold)))),

                  Padding(
                    padding: const EdgeInsets.all(20),
                    child: Text(AppTranslations.of(context).text("create_post_txt") ,style: TextStyle(fontSize: 18.0, color: Colors.black,fontWeight: FontWeight.bold)),
                  ),
                  ...
                  Container(
                    ...
                    child: RaisedButton(
                      ...
                      child: Text(AppTranslations.of(context).text("publish"), style: TextStyle(color: Colors.black, fontSize: 18,fontWeight: FontWeight.bold)),
                      onPressed: () {
  ...
  _createFeed(String origin,String destination,String feed_date,String feed_time,String fare,String commission,String taxi_type) async {
    ...
    var response = await http.Client().post(AppConstants.CREATE_FEED,
        body: {'origin': origin , 'destination': destination, 'feed_date': feed_date, "feed_time": feed_time, "fare": fare,
          "commission": commission, "taxi_type": taxi_type, "is_round_trip": '$selectTripType'},
